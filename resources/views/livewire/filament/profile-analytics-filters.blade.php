<div>
    <section class="fi-section fi-section-has-header">
        <header class="fi-section-header">
            <div class="fi-section-header-text-ctn">
                ...
                <p class="fi-section-header-description">Період впливає на KPI та графіки. За замовчуванням: 7 днів.</p>
            </div>
        </header>
            ...
            <div class="fi-sc fi-sc-has-gap fi-grid md:fi-grid-cols fi-section-content" style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-md: repeat(3, minmax(0, 1fr));">
                    ...
                    <div data-field-wrapper class="fi-fo-field fi-fo-select-wrp">
                        <div class="fi-fo-field-label-col">
                            <div class="fi-fo-field-label-ctn">
                                <label class="fi-fo-field-label" for="profile-analytics-period">
                        ...
                        <div class="fi-fo-field-content-col">
                            <div class="fi-input-wrp fi-fo-select fi-fo-select-native">
                                <div class="fi-input-wrp-content-ctn">
                                    <select id="profile-analytics-period" class="fi-select-input" wire:model.live="period">
                ...
                <div class="fi-grid-col" style="--col-span-default: span 1 / span 1;">
                    <div data-field-wrapper class="fi-fo-field">
                        <div class="fi-fo-field-label-col">
                            <div class="fi-fo-field-label-ctn">
                                <label class="fi-fo-field-label" for="profile-analytics-from">
                        ...
                        <div class="fi-fo-field-content-col">
                            <div class="fi-input-wrp fi-fo-date-time-picker">
                                <div class="fi-input-wrp-content-ctn">
                                    <input id="profile-analytics-from" class="fi-input" type="date" wire:model.live="startDate" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="fi-grid-col" style="--col-span-default: span 1 / span 1;">
                    <div data-field-wrapper class="fi-fo-field">
                        <div class="fi-fo-field-label-col">
                            <div class="fi-fo-field-label-ctn">
                                <label class="fi-fo-field-label" for="profile-analytics-to">
                        ...
                        <div class="fi-fo-field-content-col">
                            <div class="fi-input-wrp fi-fo-date-time-picker">
                                <div class="fi-input-wrp-content-ctn">
                                    <input id="profile-analytics-to" class="fi-input" type="date" wire:model.live="endDate" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div wire:loading.delay class="fi-text-sm fi-text-color-500" style="margin-top:.5rem;">
        Оновлюю аналітику...
    </div>
    ...
    @if ($record)
        <div class="space-y-5 pt-1">
            @livewire(
                \App\Filament\Resources\Profiles\Widgets\ProfileAnalyticsStatsWidget::class,
                ['record' => $record, 'period' => $period, 'from' => $startDate, 'to' => $endDate],
                key('profile-analytics-stats-' . $record->id . '-' . $period . '-' . ($startDate ?? 'null') . '-' . ($endDate ?? 'null'))
            )

            @livewire(
                \App\Filament\Resources\Profiles\Widgets\ProfileTrafficSourcesChartWidget::class,
                ['record' => $record, 'period' => $period, 'from' => $startDate, 'to' => $endDate],
                key('profile-analytics-chart-' . $record->id . '-' . $period . '-' . ($startDate ?? 'null') . '-' . ($endDate ?? 'null'))
            )
        </div>
    @endif
</div>
